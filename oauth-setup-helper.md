...
2. **Clerk Publishable Key** → `<your-clerk-publishable-key>` (copy from your Clerk dashboard)
   - This is your public key that identifies your app

3. **Clerk Secret Key** → `<your-clerk-secret-key>` (copy from your Clerk dashboard)
